<nav x-data="{ open: false }" class="bg-blue-600 border-b border-blue-700">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm font-medium rounded-md text-white hover:text-gray-200 bg-blue-600 focus:outline-none">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden bg-blue-600">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link href="{{ url('/projects') }}" class="text-white">
                {{ __('Projects') }}
            </x-responsive-nav-link>
        </div>
